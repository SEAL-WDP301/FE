    ...
    return (
        <GlassCard glow className="rounded-[24px] bg-card p-6 hover:-translate-y-1">
            ...
            <div className="grid gap-6 xl:grid-cols-[220px_minmax(0,1fr)]">
                <div className="flex flex-col items-center rounded-[22px] border border-white/10 bg-white/[0.035] p-5">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <label className="block">
                        ...
                        <Input defaultValue={profile.name} className="h-11 rounded-2xl border-white/10 bg-white/[0.03]" />
                    </label>
                    ...
                    <label className="block">
                        ...
                        <Input defaultValue={profile.slogan} className="h-11 rounded-2xl border-white/10 bg-white/[0.03]" />
                    </label>
                    ...
                    <label className="block md:col-span-2">
                        ...
                        <Textarea defaultValue={profile.description} className="min-h-24 rounded-2xl border-white/10 bg-white/[0.03]" />
                    </label>
                    ...
                    <label className="block">
                        ...
                        <Button variant="outline" className="h-11 w-full justify-between rounded-2xl border-white/10 bg-white/[0.03]">
                            {profile.track}
                    ...
                    <label className="block">
                        ...
                        <Input defaultValue={profile.university} className="h-11 rounded-2xl border-white/10 bg-white/[0.03]" />
                    </label>
